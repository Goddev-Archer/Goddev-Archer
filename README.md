``last updated: 2026-05-07 09:48:00``
___
<img width="1500" height="500" alt="Goddev Archer" src="https://github.com/user-attachments/assets/6ab00688-0c6a-4251-82a5-1825484a69b7" />
...
namespace information
{
  ...
  {
    string name = "Goddev Archer";
    string group = "Archer Independent Development Studio";
    int age = 20;
    int timeSpendWithCoding = 4;

    string output = $"This is {name} from {group}!";
    ...
    Console.WriteLine($"Time lost with coding:\t{timeSpendWithCoding} Years");
    Console.WriteLine();
  }
}
~~~
